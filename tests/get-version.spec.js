...
// ---------------------------------------------------
// ---------------------------------------------------
describe("function: get-version.js", async function () {
  // ---------------------------------------------------
  ...
  context(moduleName + " functionality tests", function () {
    ...
    it("Should accept default parameters (release)", async function (argTrace = cfgTrace) {
      ...
      expect(result.version).to.equal(latestTagName)
    })

    it("Should handle unknown event types", async function (argTrace = cfgTrace) {
      // ---------------------------------------------------
      // Details
      // ------------
    ...
    it("Should handle pull_request event", async function (argTrace = cfgTrace) {
      // ---------------------------------------------------
      // Details
      // ------------
    ...
    it("Should handle workflow_dispatch event", async function (argTrace = cfgTrace) {
      // ---------------------------------------------------
      // Details
      // ------------
    ...
    it("Should handle release event", async function (argTrace = cfgTrace) {
      // ---------------------------------------------------
      // Details
      // ------------
    ...
    it("Should handle push event with existing tags", async function (argTrace = cfgTrace) {
      // ---------------------------------------------------
      // Details
      // ------------
    ...
    it("Should handle push event with no existing tags", async function (argTrace = cfgTrace) {
      // ---------------------------------------------------
      // Details
      // ------------
      // - This test verifies the behavior of the getVersion function when a push event is received
